  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse text-center" id="navbarNav">
      ...
      <div class="nav-button d-flex flex-column flex-lg-row">
        <a href="<%= request.getContextPath() %>/registration"><button type="button" class="btn btn-outline-secondary btn-sm mx-1 fw-bold">Register</button></a>
        <button type="button" class="btn btn-primary btn-sm fw-bold">Login</button>
      </div>
    </div>
  </div>
</nav>
