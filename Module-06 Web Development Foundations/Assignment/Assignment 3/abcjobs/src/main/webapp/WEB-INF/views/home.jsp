		        ...
		        <div class="col-sm-6">
		          <div class="card border-0">
		            <div class="card-body">
		              ...
		              <a href="<%= request.getContextPath() %>/search-user" class="btn btn-outline-secondary">Find people you know</a>
		            </div>
		          </div>
		        </div>
		        <div class="col-sm-6">
		          <div class="card border-0">
		            <div class="card-body">
		              ...
		              <a href="<%= request.getContextPath() %>" class="btn btn-outline-secondary">Learn now</a>
		            </div>
		          </div>
		        </div>
		      </div>
