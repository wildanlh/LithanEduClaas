		      ...
		      <div class="card">
		        <div class="rounded-top text-white d-flex flex-row bg-dark" style="height:200px;">
		          <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
		            <img src="https://www.adinata.org/content/about/structure/1_1620680872_user.png" alt="Generic placeholder image"
		        ...
		        <div class="p-4 text-black" style="background-color: #f8f9fa;">
		          <div class="d-flex justify-content-end text-center py-1">
		            <div>
		              <span class="btn btn-primary h5">Follow</span>
		            </div>
		          </div>
		        </div>
		        <div class="card-body p-4">
		          <div class="mb-3 d-flex">
		            ...
		            <span class="btn text-dark page-link fw-bold me-3">${user.firstName}'s
		              Network</span>
		          </div>
		          <div class="row p-3 card">
		            ...
		            Incidunt, aspernatur? Dolores voluptatibus hic libero minus incidunt natus! Quas facere architecto similique
		            labore, quos asperiores! Dolores nihil sequi molestias placeat nulla praesentium perferendis sint nostrum
		            accusantium enim deserunt magnam corrupti neque ducimus dicta commodi exercitationem similique, non, facere
