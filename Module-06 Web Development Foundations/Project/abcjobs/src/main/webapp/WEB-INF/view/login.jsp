...
<body class="d-flex flex-column min-vh-100">
      ...
      <section class="h-100 mt-3">
		      ...
		      <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
		        <div class="card m-3 shadow">
		          <div class="card-body p-5">
		            ...
		            <form:form method="post" id="form" modelAttribute="loginDto" action="check" onsubmit="return checkValidation()">
		              <div class="form-floating mb-3">
		                <form:input path="emailId" type="email" class="form-control" style="${error}" placeholder="name@example.com" name="email" id="email" />
		              ...
		              <div class="d-flex align-items-center mb-5">
		                ...
		                <div class="col">
		                  <a href="<%= request.getContextPath() %>/forgotPassword" class="float-end">
		                    Forgot Password?
		                  </a>
		                </div>
		              </div>
   	...
   	<script src="script/validator-login.js"></script>
