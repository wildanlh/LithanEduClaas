        ...
        <%@ include file="../components/navbar.jsp" %>
            ...
            <div class="container my-3 ">
                <ul class="nav nav-pills border-bottom border-primary">
                    <li class="nav-item ">
                        <a class="nav-link text-secondary fw-bold " href="threads">Posts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold active" aria-current="page" href="my-thread">My Post</a>
                    </li>
                </ul>
                        ...
                        <div class="col mt-3">
                            <div class="card p-3 d-flex">
                                ...
                                <div class="my-3 text-end">
                                    <button
                                        onclick="location.href = '<%= request.getContextPath() %>/edit-thread?id=${thread.getId_thread()}';"
