    ...
    <footer class="row row-cols-5 py-5 mt-5 border-top">
      ...
      <div class="col">
        ...
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="<%= request.getContextPath() %>/" class="nav-link p-0 text-muted">Home</a></li>
      ...
      <div class="col">
        ...
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="" class="nav-link p-0 text-muted">Terms of Us</a></li>
